...
# Google Workspace AI：在 Google 體系的產品中使用 Gemini
...
![請 Gemini 生成入職須知封面圖片，直接插入文件開頭](assets/ws-docs-5.png)

## Google Slides：生成公司簡介簡報

### 📽️ 根據公司素材生成簡報

- 報到日下午要播放的`公司簡介`，用 Gemini 在 Slides 裡直接生成

#### STEP 1：打開 Google Slides 的 Gemini 對話

- 與 Docs、Sheets 相同，點擊右上角的 Gemini 圖示展開對話面板

![在 Google Slides 中打開 Gemini 對話面板](assets/ws-slides-1.png)
...
![Gemini 根據素材生成公司簡介簡報](assets/ws-slides-3.png)
