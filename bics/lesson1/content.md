...
3. ✅ 我們是[ 開在商業區的自家烘焙咖啡廳 ]，這次要推出[ 秋季限定的焙茶拿鐵與甜點套餐 ]，主打[ 上班族的午後充電時光 ]。請你扮演一位[ 熟悉在地餐飲社群經營的資深小編 ]，閱讀產品資訊後完成三件事：
   - 寫出一篇 Facebook 宣傳貼文，開頭要有吸引人的開場（Hook），結尾附上行動呼籲
   - 從「顧客」的角度，指出這篇貼文還沒回答到哪些疑慮，並說明原因
   - 針對這些疑慮，提供貼文的修改建議或補強素材供我參考

> **這套框架不是行銷人專用**
> 把[ ]裡的主角換掉就能直接套用——[ 精密零件加工廠 ]要發[ 展會邀請信 ]、[ 連鎖健身房 ]要公告[ 教練課早鳥方案 ]，結構一模一樣。
...
# 角色
你是一位專精「連鎖服務業營運與會員經營」的顧問。

# 任務
我們是台灣的「連鎖健身房品牌」，主要服務為月費會籍、教練課與團體課程，
目標客群是 25~45 歲的上班族，據點集中在北部的捷運站周邊。
...
最後附上一個「同業經營比較表格」，欄位為：品牌名稱 / 主力客群 / 服務特色 / 我們的差異化優勢
```

### 💬 要點四：詢問 AI 如何撰寫 Prompt

不知道怎麼問？讓 AI 教你問——以「規劃新品上市活動」為案例（餐飲的新菜單、製造的新產品發表、服務的新方案上線，都適用同一個框架）：

```prompt [label="請 AI 幫你優化 Prompt"]
``` 深入研究[你的公司與主力商品／服務]後，給予規劃新品上市活動的方向與具體做法 ```
...
- STEP 1：讓 ChatGPT 扮演你產業的專家，請 AI 給予提案（ex: 餐飲的新菜單企劃、製造的報價與交期說明信、服務的活動宣傳與客訴回覆）
